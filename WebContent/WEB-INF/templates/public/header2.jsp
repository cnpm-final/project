...
<!-- header -->
	...
	<nav class="navbar navBarHeader navbar-fixed-top" id="vtn">
		...
		<div class="container visible-xs visible-sm menu_top_mobile">
			<div class="come-back">
				<a href="javascript: window.history.go(-1)"> <i
					class="icon-24-white icon-back-white"></i>
				</a>
			</div>
			...
			<div class="menu_mobile floatRight">
				<a data-remodal-target="sidebarMenu" href="#" class=""> <i
					class="icon-24-white icon-bar-mb  marginRight10" aria-hidden="true"></i>
				</a>
			</div>
		</div>
					...
					<li class="search-form search-form-v2">
						<div class="input-search">
							<form class="form-inline"
								action="https://viectotnhat.com/viec-lam/tim-kiem" method="GET">
								<input type="hidden" id="project-id">
								<div class="form-group group-tu-khoa">
									<input class="form-control search-header" id="tu_khoa_ntv_1"
										name="tu_khoa" placeholder="Nhập từ khóa" type="text" value=""
										autocomplete="off">
									<div class="auto_complete" id="auto_complete_ntv_1"></div>
								</div>
								<div class="form-group group-nganh-nghe">
									<select class="select2-selectbox form-control"
										name="nganh_nghe">
